...
*/
var aa=__webpack_require__(593),ca=__webpack_require__(903);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
var react = __webpack_require__(593);
// EXTERNAL MODULE: ./node_modules/react-dom/client.js
var client = __webpack_require__(713);
;// CONCATENATED MODULE: ./styled-system/helpers.js
// src/assert.ts
...
function compactStyles(...styles) {
  return styles.filter((style) => isObject(style) && Object.keys(helpers_compact(style)).length > 0);
}
function createMergeCss(context) {
  ...
  return { mergeCss: helpers_memo(mergeCss), assignCss };
}
...
// src/slot.ts
var helpers_getSlotRecipes = (recipe = {}) => {
  const init = (slot) => ({
...
;// CONCATENATED MODULE: ./styled-system/css/conditions.js


const conditionsStr = "_hover,_focus,_focusWithin,_focusVisible,_disabled,_active,_visited,_target,_readOnly,_readWrite,_empty,_checked,_enabled,_expanded,_highlighted,_before,_after,_firstLetter,_firstLine,_marker,_selection,_file,_backdrop,_first,_last,_only,_even,_odd,_firstOfType,_lastOfType,_onlyOfType,_peerFocus,_peerHover,_peerActive,_peerFocusWithin,_peerFocusVisible,_peerDisabled,_peerChecked,_peerInvalid,_peerExpanded,_peerPlaceholderShown,_groupFocus,_groupHover,_groupActive,_groupFocusWithin,_groupFocusVisible,_groupDisabled,_groupChecked,_groupExpanded,_groupInvalid,_indeterminate,_required,_valid,_invalid,_autofill,_inRange,_outOfRange,_placeholder,_placeholderShown,_pressed,_selected,_default,_optional,_open,_closed,_fullscreen,_loading,_currentPage,_currentStep,_motionReduce,_motionSafe,_print,_landscape,_portrait,_dark,_light,_osDark,_osLight,_highContrast,_lessContrast,_moreContrast,_ltr,_rtl,_scrollbar,_scrollbarThumb,_scrollbarTrack,_horizontal,_vertical,_starting,@mobile,@mobileOnly,@mobileDown,@tablet,@tabletOnly,@tabletDown,@desktop,@desktopOnly,@desktopDown,@mobileTo@tablet,@mobileTo@desktop,@tabletTo@desktop,base"
...
const context = {
  ...
  conditions: {
    ...
    breakpoints: { keys: ["base","@mobile","@tablet","@desktop"] }
  },
  utility: {
    
    transform: (key, value) => ({ className: `${classNameByProp.get(key) || hypenateProperty(key)}-${withoutSpace(value)}` }),
...
const css = (...styles) => cssFn(css_mergeCss(...styles))
css.raw = (...styles) => css_mergeCss(...styles)

const { mergeCss: css_mergeCss, assignCss } = createMergeCss(context)
;// CONCATENATED MODULE: ./styled-system/css/cx.js
function cx_cx() {
  let str = '',
    i = 0,
    arg
...
;// CONCATENATED MODULE: ./styled-system/css/cva.js
...
function cva_cva(config) {
  const { base, variants, defaultVariants, compoundVariants } = defaults(config)
  const getVariantProps = (variants) => ({ ...defaultVariants, ...helpers_compact(variants) })
  ...
  function resolve(props = {}) {
    ...
    for (const [key, value] of Object.entries(computedVariants)) {
      if (variants[key]?.[value]) {
        variantCss = css_mergeCss(variantCss, variants[key][value])
      }
    }
    const compoundVariantCss = getCompoundVariantCss(compoundVariants, computedVariants)
    return css_mergeCss(variantCss, compoundVariantCss)
  }
  ...
  function merge(__cva) {
    ...
    return cva_cva({
      base: css_mergeCss(base, override.base),
      variants: Object.fromEntries(
        variantKeys.map((key) => [key, css_mergeCss(variants[key], override.variants[key])]),
      ),
  ...
  return Object.assign(helpers_memo(cvaFn), {
    __cva__: true,
    variantMap,
    variantKeys,
    raw: resolve,
...
function getCompoundVariantCss(compoundVariants, variantMap) {
  ...
  compoundVariants.forEach((compoundVariant) => {
    ...
    if (isMatching) {
      result = css_mergeCss(result, compoundVariant.css)
    }
  })
...
;// CONCATENATED MODULE: ./styled-system/css/sva.js
...
;// CONCATENATED MODULE: ./styled-system/css/index.js




;// CONCATENATED MODULE: ./styled-system/jsx/is-valid-prop.js
...
;// CONCATENATED MODULE: ./styled-system/jsx/factory-helper.js
...
;// CONCATENATED MODULE: ./styled-system/jsx/factory.js
...
function styledFn(Dynamic, configOrCva = {}, options = {}) {
  const cvaFn = configOrCva.__cva__ || configOrCva.__recipe__ ? configOrCva : cva_cva(configOrCva)
  ...
  const StyledComponent = /* @__PURE__ */ (0,react.forwardRef)(function StyledComponent(props, ref) {
    ...
    const [htmlProps, forwardedProps, variantProps, styleProps, elementProps] = (0,react.useMemo)(() => {
      return helpers_splitProps(combinedProps, normalizeHTMLProps.keys, __shouldForwardProps__, __cvaFn__.variantKeys, isCssProperty)
    }, [combinedProps])

    function recipeClass() {
      const { css: cssStyles, ...propStyles } = styleProps
      const compoundVariantStyles = __cvaFn__.__getCompoundVariantCss__?.(variantProps)
      return cx_cx(__cvaFn__(variantProps, false), css(compoundVariantStyles, propStyles, cssStyles), combinedProps.className)
    }

    function cvaClass() {
      const { css: cssStyles, ...propStyles } = styleProps
      const cvaStyles = __cvaFn__.raw(variantProps)
      return cx_cx(css(cvaStyles, propStyles, cssStyles), combinedProps.className)
    }
...
;// CONCATENATED MODULE: ./styled-system/patterns/box.js
...
const box_getBoxStyle = (styles = {}) => {
  const _styles = getPatternStyles(boxConfig, styles)
  return boxConfig.transform(_styles, patternFns)
}

const box = (styles) => css(box_getBoxStyle(styles))
box.raw = box_getBoxStyle
;// CONCATENATED MODULE: ./styled-system/jsx/box.js
...
const Box = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function Box(props, ref) {
...
;// CONCATENATED MODULE: ./styled-system/patterns/flex.js
...
const flex_getFlexStyle = (styles = {}) => {
  const _styles = getPatternStyles(flexConfig, styles)
  return flexConfig.transform(_styles, patternFns)
}

const flex = (styles) => css(flex_getFlexStyle(styles))
flex.raw = flex_getFlexStyle
;// CONCATENATED MODULE: ./styled-system/jsx/flex.js
...
const Flex = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function Flex(props, ref) {
...
;// CONCATENATED MODULE: ./styled-system/patterns/stack.js
...
const stack_getStackStyle = (styles = {}) => {
  const _styles = getPatternStyles(stackConfig, styles)
  return stackConfig.transform(_styles, patternFns)
}

const stack = (styles) => css(stack_getStackStyle(styles))
stack.raw = stack_getStackStyle
;// CONCATENATED MODULE: ./styled-system/jsx/stack.js
...
const Stack = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function Stack(props, ref) {
...
;// CONCATENATED MODULE: ./styled-system/patterns/vstack.js
...
const vstack_getVstackStyle = (styles = {}) => {
  const _styles = getPatternStyles(vstackConfig, styles)
  return vstackConfig.transform(_styles, patternFns)
}

const vstack = (styles) => css(vstack_getVstackStyle(styles))
vstack.raw = vstack_getVstackStyle
;// CONCATENATED MODULE: ./styled-system/jsx/vstack.js
...
const VStack = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function VStack(props, ref) {
...
;// CONCATENATED MODULE: ./styled-system/patterns/hstack.js
...
const hstack_getHstackStyle = (styles = {}) => {
  const _styles = getPatternStyles(hstackConfig, styles)
  return hstackConfig.transform(_styles, patternFns)
}

const hstack = (styles) => css(hstack_getHstackStyle(styles))
hstack.raw = hstack_getHstackStyle
;// CONCATENATED MODULE: ./styled-system/jsx/hstack.js
...
const HStack = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function HStack(props, ref) {
  const [patternProps, restProps] = splitProps(props, ["justify","gap"])
...
;// CONCATENATED MODULE: ./styled-system/patterns/spacer.js
...
const spacer = (styles) => css(spacer_getSpacerStyle(styles))
spacer.raw = spacer_getSpacerStyle
;// CONCATENATED MODULE: ./styled-system/jsx/spacer.js
...
;// CONCATENATED MODULE: ./styled-system/patterns/square.js
...
const square_getSquareStyle = (styles = {}) => {
  const _styles = getPatternStyles(squareConfig, styles)
  return squareConfig.transform(_styles, patternFns)
}

const square = (styles) => css(square_getSquareStyle(styles))
square.raw = square_getSquareStyle
;// CONCATENATED MODULE: ./styled-system/jsx/square.js
...
const Square = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function Square(props, ref) {
  const [patternProps, restProps] = splitProps(props, ["size"])
...
;// CONCATENATED MODULE: ./styled-system/patterns/circle.js
...
const circle_getCircleStyle = (styles = {}) => {
  const _styles = getPatternStyles(circleConfig, styles)
  return circleConfig.transform(_styles, patternFns)
}

const circle = (styles) => css(circle_getCircleStyle(styles))
circle.raw = circle_getCircleStyle
;// CONCATENATED MODULE: ./styled-system/jsx/circle.js
...
const Circle = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function Circle(props, ref) {
  const [patternProps, restProps] = splitProps(props, ["size"])
...
;// CONCATENATED MODULE: ./styled-system/patterns/center.js
...
const center = (styles) => css(center_getCenterStyle(styles))
center.raw = center_getCenterStyle
;// CONCATENATED MODULE: ./styled-system/jsx/center.js
...
;// CONCATENATED MODULE: ./styled-system/patterns/link-box.js
...
const link_box_getLinkBoxStyle = (styles = {}) => {
  const _styles = getPatternStyles(linkBoxConfig, styles)
  return linkBoxConfig.transform(_styles, patternFns)
}

const linkBox = (styles) => css(link_box_getLinkBoxStyle(styles))
linkBox.raw = link_box_getLinkBoxStyle
;// CONCATENATED MODULE: ./styled-system/jsx/link-box.js
...
const LinkBox = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function LinkBox(props, ref) {
  const [patternProps, restProps] = splitProps(props, [])
...
;// CONCATENATED MODULE: ./styled-system/patterns/link-overlay.js
...
const linkOverlay = (styles) => css(link_overlay_getLinkOverlayStyle(styles))
linkOverlay.raw = link_overlay_getLinkOverlayStyle
;// CONCATENATED MODULE: ./styled-system/jsx/link-overlay.js
...
;// CONCATENATED MODULE: ./styled-system/patterns/aspect-ratio.js
...
const aspectRatio = (styles) => css(aspect_ratio_getAspectRatioStyle(styles))
aspectRatio.raw = aspect_ratio_getAspectRatioStyle
;// CONCATENATED MODULE: ./styled-system/jsx/aspect-ratio.js
...
;// CONCATENATED MODULE: ./styled-system/patterns/grid.js
...
const grid_getGridStyle = (styles = {}) => {
  const _styles = getPatternStyles(gridConfig, styles)
  return gridConfig.transform(_styles, patternFns)
}

const grid = (styles) => css(grid_getGridStyle(styles))
grid.raw = grid_getGridStyle
;// CONCATENATED MODULE: ./styled-system/jsx/grid.js
...
const Grid = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function Grid(props, ref) {
...
;// CONCATENATED MODULE: ./styled-system/patterns/grid-item.js
...
const grid_item_getGridItemStyle = (styles = {}) => {
  const _styles = getPatternStyles(gridItemConfig, styles)
  return gridItemConfig.transform(_styles, patternFns)
}

const gridItem = (styles) => css(grid_item_getGridItemStyle(styles))
gridItem.raw = grid_item_getGridItemStyle
;// CONCATENATED MODULE: ./styled-system/jsx/grid-item.js
...
const GridItem = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function GridItem(props, ref) {
...
;// CONCATENATED MODULE: ./styled-system/patterns/wrap.js
...
const wrap = (styles) => css(wrap_getWrapStyle(styles))
wrap.raw = wrap_getWrapStyle
;// CONCATENATED MODULE: ./styled-system/jsx/wrap.js
...
;// CONCATENATED MODULE: ./styled-system/patterns/container.js
...
const container = (styles) => css(container_getContainerStyle(styles))
container.raw = container_getContainerStyle
;// CONCATENATED MODULE: ./styled-system/jsx/container.js
...
;// CONCATENATED MODULE: ./styled-system/patterns/divider.js
...
const divider_getDividerStyle = (styles = {}) => {
  const _styles = getPatternStyles(dividerConfig, styles)
  return dividerConfig.transform(_styles, patternFns)
}

const divider = (styles) => css(divider_getDividerStyle(styles))
divider.raw = divider_getDividerStyle
;// CONCATENATED MODULE: ./styled-system/jsx/divider.js
...
const Divider = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function Divider(props, ref) {
...
;// CONCATENATED MODULE: ./styled-system/patterns/float.js
...
const float_float = (styles) => css(float_getFloatStyle(styles))
float_float.raw = float_getFloatStyle
;// CONCATENATED MODULE: ./styled-system/jsx/float.js
...
;// CONCATENATED MODULE: ./styled-system/patterns/bleed.js
...
const bleed = (styles) => css(bleed_getBleedStyle(styles))
bleed.raw = bleed_getBleedStyle
;// CONCATENATED MODULE: ./styled-system/jsx/bleed.js
...
;// CONCATENATED MODULE: ./styled-system/patterns/visually-hidden.js
...
const visually_hidden_getVisuallyHiddenStyle = (styles = {}) => {
  const _styles = getPatternStyles(visuallyHiddenConfig, styles)
  return visuallyHiddenConfig.transform(_styles, patternFns)
}

const visuallyHidden = (styles) => css(visually_hidden_getVisuallyHiddenStyle(styles))
visuallyHidden.raw = visually_hidden_getVisuallyHiddenStyle
;// CONCATENATED MODULE: ./styled-system/jsx/visually-hidden.js
...
const VisuallyHidden = /* @__PURE__ */ (/* unused pure expression or super */ null && (forwardRef(function VisuallyHidden(props, ref) {
  const [patternProps, restProps] = splitProps(props, [])
...
;// CONCATENATED MODULE: ./styled-system/patterns/cq.js
...
const cq = (styles) => css(cq_getCqStyle(styles))
cq.raw = cq_getCqStyle
;// CONCATENATED MODULE: ./styled-system/jsx/cq.js
...
;// CONCATENATED MODULE: ./styled-system/jsx/index.js
...
var box_Box = factory_styled('div', {
  base: {
    padding: {
      '@mobile': 200,
      '@tablet': 300,
...
var App = function App() {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(box_Box, {
    foo: "success"
  }, "success"), /*#__PURE__*/react.createElement(box_Box, {
    foo: "error"
  }, "error"), /*#__PURE__*/react.createElement(box_Box, {
    foo: "info"
  }, "info"));
};
